...
public class BreakScript extends Script {
    ...
    public BreakScript(String name, List<String> GUILore, List<String> clearMessages, HashSet<Material> blockSet, QuestEvent event, List<String> commands, List<ItemStack> rewards) {
